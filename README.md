...
An interactive business intelligence dashboard built in Tableau for analysing employee travel expenses at Axiom Inc. The project focuses on helping a Finance Office Manager monitor ticket spend, booking behaviour, fare types, employee travel patterns, and high-frequency routes.
> This dashboard is designed to support travel cost control by linking spend to booking lead time, fare selection, traveller behaviour, and route concentration.
---
Live Dashboard
View on Tableau Public
---
Dashboard Preview
![Employee Travel Expense Dashboard](Desktp/dashboard.png)
---
PrepBuilder Preview
![Employee Travel Expense PrepBuilder](Cleaning/prepbuilder.png)
---
...
The main goal of the dashboard is to make it easier to identify where avoidable travel costs may be reduced through better booking habits, route planning, and fare type control.
---
Key KPIs
...
Project Structure
```text
EMPLOYEE\_TRAVEL\_EXPENSE\_DASHBOARD/
├── Desktop/
│   ├── Dashboard.twbx
│   └── dashboard.png
│
